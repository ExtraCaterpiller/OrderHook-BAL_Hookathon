...
import {BalancerPoolToken} from "@balancer-labs/contracts/vault/contracts/BalancerPoolToken.sol";
import {IBasePool} from "@balancer-labs/v3-interfaces/contracts/vault/IBasePool.sol";
import {Rounding} from "@balancer-labs/contracts/interfaces/contracts/vault/VaultTypes.sol";
...
contract ConstantProductPool is BalancerPoolToken, IBasePool {
    ...
    function onSwap(
        ...
        amountCalculatedScaled18 =
            ...
            (poolBalancetokenIn + amountTokenIn);
    }
    ...
    function computeInvariant(
        ...
        invariant = invariant.mulDown(balancesLiveScaled18[0]).mulDown(
    ...
    function computeBalance(
        ...
        uint256 newInvariant = computeInvariant(balancesLiveScaled18).mulDown(
            invariantRatio
        );
    ...
    function computeInvariant(
        uint256[] memory balancesLiveScaled18,
        Rounding /* rounding */
    ) external pure override returns (uint256 invariant) {
